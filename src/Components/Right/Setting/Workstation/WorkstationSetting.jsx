...
export default function WorkstationSetting({ objectType }) {
  ...
  const { stationtype, wsname, wsdescription, wslabname, wslabId, wslabdescription, wsconfigmemory, wsconfigcpu, wsconfigarchitecture, wsconfigmodel, wsdocuments } = useSelector(state => state.scenario);
  ...
  const deleteListItem = (index)=>{
    const newArray = [...wsdocuments];
    newArray.splice(index, 1);
  
    dispatch(setformValue({
      wsdocuments: newArray
    }));
  ...
  const setFieldValue = (index) => {
    ...
    dispatch(setformValue({
      wslabname: formData.name,
      wslabdescription: formData.description,
      wslabId: formData.id
    }));
  };
  ...
  const uploadDocument = (e) => {
    const updatedDocumentList = [...wsdocuments, e[0]];
    
    dispatch(setformValue({
      wsdocuments: updatedDocumentList
    }));
  ...
  return (
    <>
    <div className="titleForShow">{objectType} Setting</div>
      <div className="accordion">
        <div className={`accordion-item ${activeSection === 0 ? 'active' : ''}`}>
          <div className="accordion-header" onClick={() => toggleAccordion(0)}>
            <span>General</span>
            <span>{activeSection === 0 ? <FaAngleUp /> : <FaAngleDown />}</span>
          </div>
          <div className="accordion-content">
            ...
            <div className="inputfieldWithLabel">
              ...
              <input
                ...
                onChange={(e)=>{
                  dispatch(setformValue({wsname: e.target.value}));
                }}
                value={wsname}
              />
            </div>
            <div className="inputfieldWithLabel">
              ...
              <input
                ...
                className="inputfieldT"
                onChange={(e)=>{
                  dispatch(setformValue({wsdescription: e.target.value}));
                }}
                value={wsdescription}
              />
            </div>
        ...
        <div className={`accordion-item ${activeSection === 1 ? 'active' : ''}`}>
          <div className="accordion-header" onClick={() => toggleAccordion(1)}>
            <span>Lab</span>
            <span>{activeSection === 1 ? <FaAngleUp /> : <FaAngleDown />}</span>
          </div>
          <div className="accordion-content">
            <div className="inputfieldWithLabel">
              <input
                        ...
                        <div className="accordion-content">
                          <div className="inputfieldWithLabel">
                            ...
                            <input
                              ...
                              onChange={(e)=>{
                                dispatch(setformValue({wsconfigmemory: e.target.value}));
                              }}
                              value={wsconfigmemory}
                          ...
                          <div className="inputfieldWithLabel">
                            ...
                            <input
                              ...
                              onKeyPress={handleKeyPress}
                              onChange={(e)=>{
                                dispatch(setformValue({wsconfigcpu: e.target.value}));
                              }}
                              value={wsconfigcpu}
                            />
                          </div>
                          <div className="inputfieldWithLabel">
                            ...
                            <input
                              ...
                              className="inputfieldT"
                              onChange={(e)=>{
                                dispatch(setformValue({wsconfigarchitecture: e.target.value}));
                              }}
                              value={wsconfigarchitecture}
                            />
                          </div>
                          <div className="inputfieldWithLabel">
                            ...
                            <input
                              ...
                              className="inputfieldT"
                              onChange={(e)=>{
                                dispatch(setformValue({wsconfigmodel: e.target.value}));
                              }}
                              value={wsconfigmodel}
                            />
                          </div>
        ...
        <div className={`accordion-item ${activeSection === 2 ? 'active' : ''}`}>
          <div className="accordion-header" onClick={() => toggleAccordion(2)}>
            <span>Documents</span>
            <span>{activeSection === 2 ? <FaAngleUp /> : <FaAngleDown />}</span>
          </div>
...
"application/msword, application/vnd.ms-excel, application/vnd.ms-powerpoint,text/plain, application/pdf, image/*"
  ...
  {wsdocuments.length >0 ? <>{wsdocuments?.map((value, index) => {
